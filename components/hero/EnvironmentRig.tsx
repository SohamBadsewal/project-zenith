...
export function EnvironmentRig() {
  ...
  return (
    <>
      ...
      <Stars radius={220} depth={80} count={isMobile ? 800 : 3000} factor={4.5} saturation={0} fade speed={0.5} />
      <Sparkles count={isMobile ? 15 : 60} scale={[70, 70, 70]} size={2.2} speed={0.15} color="#cfe0ff" opacity={0.45} />
    </>
  );
}
